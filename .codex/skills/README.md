...
| Skill | Purpose |
|---|---|
| `deal-agent` | Orchestrator — runs all sub-skills in sequence |
...
Usage: `/deal-agent <slug>` for end-to-end, or invoke individual skills. `/reconcile-alex <slug>` is post-export only.
