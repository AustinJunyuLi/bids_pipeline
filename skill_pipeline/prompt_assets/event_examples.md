...
Expected:
- proposal event for Party A: range $7.50-$8.00, whole_company_scope=true, contains_range=true, mentions_indication_of_interest=true
...
Expected:
- final_round_ann event: date December 19, 2012, round_scope=formal
