...
description: Fetches selected SEC filings, converts them to immutable text snapshots, and writes corpus manifests. Use after filing selection or when frozen filing archives need to be rebuilt.
---
