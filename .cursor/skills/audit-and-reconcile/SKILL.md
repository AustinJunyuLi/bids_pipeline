---
name: audit-and-reconcile
description: Verifies quotes against frozen text, reconciles counts, and runs structural audit checks with fresh-eyes review. Use after event extraction or when audit flags and census outputs need to be rebuilt.
---
