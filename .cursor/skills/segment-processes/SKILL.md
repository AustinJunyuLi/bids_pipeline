...
description: Segments terminated and restarted deal cycles and builds round structures with invited sets. Use after event extraction or when process-cycle boundaries need to be reconstructed.
---
