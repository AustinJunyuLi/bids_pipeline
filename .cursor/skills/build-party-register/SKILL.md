---
name: build-party-register
description: Builds the initial actor roster and filing count assertions from the chronology narrative. Use before event extraction or when actor identities and NDA or bid counts need to be reconstructed.
---
