...
│   │   ├── imprivata/
│   │   │   ├── extract/
│   │   │   │   ├── actors_raw.json          # Legacy raw shape or canonical span-backed actors
│   │   │   │   ├── events_raw.json          # Legacy raw shape or canonical span-backed events
│   │   │   │   └── spans.json               # Required once canonicalized
│   │   │   ├── check/
│   │   │   │   └── check_report.json
│   │   │   ├── verify/
...
- Contents: `actors_raw.json` and `events_raw.json` in both modes; canonicalization upgrades those files in place and adds `spans.json`
- Generated by: External `/extract-deal` command, then `canonicalize`
